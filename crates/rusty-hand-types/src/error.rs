//! Shared error types for the RustyHand system.

use thiserror::Error;

/// Top-level error type for the RustyHand system.
#[derive(Error, Debug)]
pub enum RustyHandError {
...
/// Alias for Result with RustyHandError.
pub type RustyHandResult<T> = Result<T, RustyHandError>;
