...
pub struct MatrixConfig {
    ...
    /// Bot user ID (e.g., "@rustyhand:matrix.org").
    pub user_id: String,
...
pub struct IrcConfig {
    ...
    /// Channels to join (e.g., `["#rustyhand", "#general"]`).
