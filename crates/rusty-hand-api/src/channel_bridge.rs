...
use rusty_hand_channels::google_chat::GoogleChatAdapter;
use rusty_hand_channels::irc::IrcAdapter;
use rusty_hand_channels::matrix::MatrixAdapter;
use rusty_hand_channels::mattermost::MattermostAdapter;
use rusty_hand_channels::rocketchat::RocketChatAdapter;
use rusty_hand_channels::router::AgentRouter;
use rusty_hand_channels::signal::SignalAdapter;
use rusty_hand_channels::slack::SlackAdapter;
use rusty_hand_channels::teams::TeamsAdapter;
use rusty_hand_channels::telegram::TelegramAdapter;
use rusty_hand_channels::twitch::TwitchAdapter;
use rusty_hand_channels::types::ChannelAdapter;
use rusty_hand_channels::whatsapp::WhatsAppAdapter;
use rusty_hand_channels::zulip::ZulipAdapter;
// Wave 3
use rusty_hand_channels::bluesky::BlueskyAdapter;
use rusty_hand_channels::feishu::FeishuAdapter;
use rusty_hand_channels::line::LineAdapter;
use rusty_hand_channels::mastodon::MastodonAdapter;
use rusty_hand_channels::messenger::MessengerAdapter;
use rusty_hand_channels::reddit::RedditAdapter;
use rusty_hand_channels::revolt::RevoltAdapter;
use rusty_hand_channels::viber::ViberAdapter;
// Wave 4
use rusty_hand_channels::flock::FlockAdapter;
use rusty_hand_channels::guilded::GuildedAdapter;
use rusty_hand_channels::keybase::KeybaseAdapter;
use rusty_hand_channels::nextcloud::NextcloudAdapter;
use rusty_hand_channels::pumble::PumbleAdapter;
use rusty_hand_channels::threema::ThreemaAdapter;
use rusty_hand_channels::twist::TwistAdapter;
use rusty_hand_channels::webex::WebexAdapter;
// Wave 5
use async_trait::async_trait;
use rusty_hand_channels::dingtalk::DingTalkAdapter;
use rusty_hand_channels::discourse::DiscourseAdapter;
use rusty_hand_channels::gitter::GitterAdapter;
use rusty_hand_channels::gotify::GotifyAdapter;
use rusty_hand_channels::linkedin::LinkedInAdapter;
use rusty_hand_channels::mumble::MumbleAdapter;
use rusty_hand_channels::ntfy::NtfyAdapter;
use rusty_hand_channels::webhook::WebhookAdapter;
