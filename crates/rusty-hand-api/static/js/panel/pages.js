...
function WorkflowsPage() {
  ...
  const [runsResp, , refreshRuns] = usePolling(active ? `/api/workflows/${encodeURIComponent(active.id)}/runs` : null, 8e3);
...
function AuditPage() {
  const [audit, , refresh] = usePolling("/api/audit/recent?n=200", 8e3);
