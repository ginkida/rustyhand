...
use base64::Engine;
use rusty_hand_types::media::{GeneratedImage, ImageGenRequest, ImageGenResult};
use tracing::warn;
...
pub async fn generate_image(request: &ImageGenRequest) -> Result<ImageGenResult, String> {
    ...
    if request.model == rusty_hand_types::media::ImageGenModel::DallE3 {
...
mod tests {
    use super::*;
    use rusty_hand_types::media::ImageGenModel;
