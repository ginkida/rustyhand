...
use rusty_hand_types::config::{KernelConfig, ReloadMode};
...
mod tests {
    ...
    fn test_channels_hot_reload() {
        ...
        b.channels.telegram = Some(rusty_hand_types::config::TelegramConfig {
    ...
    fn test_usage_footer_hot_reload() {
        use rusty_hand_types::config::UsageFooterMode;
        let a = default_cfg();
        let mut b = default_cfg();
