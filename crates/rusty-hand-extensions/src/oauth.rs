...
pub fn default_client_ids() -> HashMap<&'static str, &'static str> {
    ...
    m.insert("google", "rusty-hand-google-client-id");
    m.insert("github", "rusty-hand-github-client-id");
    m.insert("microsoft", "rusty-hand-microsoft-client-id");
    m.insert("slack", "rusty-hand-slack-client-id");
    m
}
