//! Ratatui TUI for RustyHand interactive mode.
//!
//! Two-level navigation: Phase::Boot (Welcome/Wizard) → Phase::Main with 17 tabs.
...
enum Backend {
    ...
    InProcess { kernel: Arc<RustyHandKernel> },
    None,
}
...
impl App {
    ...
    fn handle_stream_done(
        &mut self,
        result: Result<rusty_hand_runtime::agent_loop::AgentLoopResult, String>,
    ) {
    ...
    fn handle_kernel_ready(&mut self, kernel: Arc<RustyHandKernel>) {
