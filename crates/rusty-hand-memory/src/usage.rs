...
impl UsageStore {
    ...
    pub fn query_hourly(&self, agent_id: AgentId) -> RustyHandResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
    ...
    pub fn query_daily(&self, agent_id: AgentId) -> RustyHandResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
    ...
    pub fn query_monthly(&self, agent_id: AgentId) -> RustyHandResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
    ...
    pub fn query_global_hourly(&self) -> RustyHandResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
    ...
    pub fn query_global_monthly(&self) -> RustyHandResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
    ...
    pub fn query_summary(&self, agent_id: Option<AgentId>) -> RustyHandResult<UsageSummary> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
    ...
    pub fn query_by_model(&self) -> RustyHandResult<Vec<ModelUsage>> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
        ...
        for row in rows {
            results.push(row.map_err(|e| RustyHandError::Memory(e.to_string()))?);
        }
        Ok(results)
    }

    /// Query daily usage breakdown for the last N days.
    pub fn query_daily_breakdown(&self, days: u32) -> RustyHandResult<Vec<DailyBreakdown>> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
    ...
    pub fn query_first_event_date(&self) -> RustyHandResult<Option<String>> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
    ...
    pub fn query_today_cost(&self) -> RustyHandResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
    ...
    pub fn cleanup_old(&self, days: u32) -> RustyHandResult<usize> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| RustyHandError::Internal(e.to_string()))?;
